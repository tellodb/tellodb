...
DATASET_PATH="${LONGMEMEVAL_DATASET:-$SCRIPT_DIR/LongMemEval/data/longmemeval_s_cleaned.json}"
...
if [[ ! -f "$DATASET_PATH" ]]; then
  echo "LongMemEval dataset not found at: $DATASET_PATH" >&2
  echo "Expected file: longmemeval_s_cleaned.json" >&2
  exit 1
fi
