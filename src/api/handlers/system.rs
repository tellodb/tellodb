...
pub async fn version_handler(
    ...
    let response = (
        ...
        Json(VersionResponse {
            ...
            rerank_policy: crate::query::rerank::rerank_policy_name(&state.config),
            lanes: state.config.lanes.enabled_names(),
            heuristics: state.config.heuristics.name(),
            rerank_margin: crate::query::rerank::rerank_margin(&state.config),
            rerank_top: crate::query::rerank::rerank_top(&state.config),
