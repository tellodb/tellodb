...
fn scope(
    ...
    (std::sync::Arc<crate::storage::TenantStore>, String, crate::api::auth::RequestPrincipal),
    StatusCode,
> {
...
pub async fn current_fact_handler(
    ...
    let (tenant, entity_id, principal) = scope(&state, &headers, params.entity_id.as_deref())?;
